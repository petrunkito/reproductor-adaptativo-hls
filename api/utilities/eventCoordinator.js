...
//*si la subida de los archivos a terminado se dispara el evento "uploadedFiles"
...
let path = require("path")//?para unir las rutas sin temer al sistema operativo
...
//?de tal modo, que el siguiente paso es fragmentar cada uno de los archivos al formato Hls y es lo que hace 
//?el siguiente codigo
...
//?de tal modo, que el siguiente paso es crear los registros en la base de datos del modelo
//?"File" y "Playlist" con la respectiva informacion del archivo y sus fragmentos creados, y es lo que hace
//?el siguiente codigo
emitter.on("hlsFilesCreated", async (data) => {
    ...
    */
        ...
        let readableStream = fs.createReadStream(path.join(paths.pathFile, data.folderName, "playlist.m3u8"))

        //?en esta variable se almacenara los datos que se insertaran en el modelPlaylist como:
        /*
          {
            folderName,
            resolutions,
        ...
        readableStream.on("end", async () => {
            ...
            */
            ...
            for (let i = 0; i < manifests.length; i++) {
                let element = {}
                element.resolution = playlist.resolutions[i]//?tambien agregamos sus respectiva resolucion, para que luego la busqueda de los fragmentos sea mas facil
                ...
                let file = fs.readFileSync(path.join(paths.pathFile, data.folderName, manifests[i])).toString()
            ...
            folderName: 'a60f259fd8734935b9bfe5b63893d43f',
